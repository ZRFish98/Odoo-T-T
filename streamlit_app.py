#!/usr/bin/env python3
"""
T&T Purchase Order Processor - Combined Streamlit Application
...
def main():
    ...
    # Step indicators
    steps = ["1. Upload Reference Data", "2. Upload PDF Files", "3. Process & Convert", "4. Download Results"]
    ...
    if st.session_state.step == 1:
        ...
        st.info("📁 Please upload the required reference files before processing PDFs.")
    ...
    # Step 2: Upload PDF Files
        ...
        st.markdown('<h2 class="step-header">Step 2: Upload T&T PO PDF Files</h2>', unsafe_allow_html=True)
        
        st.info("📄 Upload one or more T&T Purchase Order PDF files for processing.")
    ...
    # Step 3: Process & Convert
        ...
        if st.session_state.purchase_orders is not None:
            st.info("🔄 Converting extracted data to Odoo-compatible format...")
    ...
    with st.sidebar.expander("ℹ️ Help & Instructions"):
        ...
        **How to use this tool:**
        ...
        2. **Upload PDF Files**: Upload T&T Purchase Order PDF files
